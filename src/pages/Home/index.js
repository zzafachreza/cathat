  ...
  return (
    <SafeAreaView style={{
      ...
      <ScrollView>
        ...
        {/* HEADER */}
        <View style={{
          padding: 20, backgroundColor: colors.primary, borderBottomLeftRadius: 50, borderBottomRightRadius: 50,
          ...
          <View style={{
            ...
            <TouchableWithoutFeedback onPress={() => Alert.alert(MYAPP, 'Apakah kamu yakin akan keluar aplikasi ?', [
              { text: 'TIDAK' },
              {
                text: 'Ya, Keluar',
                onPress: () => {
          ...
          <View style={{ marginTop: '5%', padding: 20, }}>
            <View style={{ flexDirection: "column", }}>
              <TouchableWithoutFeedback onPress={() => navigation.navigate('Identitas')}>
                <View style={{
                  padding: 10, backgroundColor: colors.secondary, borderRadius: 10,
